...
function mudarVencedor(quadrado) {
    ...
    window.alert("Jogador '"+vencedor+"', PARABÉNS VOCÊ VENCEU!")
}
...
iconbuttom.addEventListener("click", () => {
        body.classList.toggle("dark-mode");
        if (iconbuttom.classList == 'bi bi-toggle-off') {
            iconbuttom.classList = 'bi bi-toggle-on';
        } else if (iconbuttom.classList == 'bi bi-toggle-on') {
            iconbuttom.classList = 'bi bi-toggle-off';
        }
    })
